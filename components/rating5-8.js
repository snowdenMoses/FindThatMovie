...
const heightPercentage=(height*56)/100;
...
export default function RatingFiveToEight({route,navigation}) {
  ...
  const [page1, setPage1] = useState(2);
            ...
            const searchApi = async ()=>{
                ...
                fetch('https://api.themoviedb.org/3/discover/movie?api_key=0a64a623fd5125911262eca5a87730a5&language=en-US&vote_average.lte=8&vote_average.gte=5&page='+page1+'&vote_count.gte=2000&sort_by=vote_count.desc')
 ...
 /*if (result.length === null) {
  ...
  function LoadingFunction(){
    ...
    return(
      ...
      onPress={()=>navigation.navigate('Pg 2',{
        nextPage:page1,
      })}>
