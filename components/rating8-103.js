...
export default function Rating8Above3({route,navigation}) {
  ...
  const {page3}=route.params;
  const currentPage=page3+1
  ...
  const api = '0a64a623fd5125911262eca5a87730a5';
            ...
            const searchApi = async ()=>{
                ...
                await fetch('https://api.themoviedb.org/3/discover/movie?api_key=0a64a623fd5125911262eca5a87730a5&language=en-US&vote_average.lte=10&vote_average.gte=8&page='+currentPage+'&vote_count.gte=2000&sort_by=vote_count.desc')
 ...
 /*if (result.length === null) {
  ...
  //     <TouchableOpacity onPress={()=>navigation.navigate('8-10 Rating2',{
  //       nextPage:page
  //     })}> 
  //       <Text>Next</Text>
  //     </TouchableOpacity>
