...
export default function LandingPage4({navigation}) {
  ...
  const api = '0a64a623fd5125911262eca5a87730a5';
            ...
            const searchApi = (searchTerm)=>{
               ...
               // fetch('https://api.themoviedb.org/3/trending/all/week?api_key=0a64a623fd5125911262eca5a87730a5&language=en-US&page=1')
               fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=0a64a623fd5125911262eca5a87730a5&language=en-US&page=1')
  ...
  function LoadingFunction(){
    ...
    return(
      ...
      onPress={()=>navigation.navigate('ByAllTime2')}>
