...
export default function LandingPage3({navigation}) {
  ...
  const year = dt.getFullYear()
            ...
            const searchApi = (searchTerm)=>{
                ...
                fetch('https://api.themoviedb.org/3/discover/movie?api_key=0a64a623fd5125911262eca5a87730a5&language=en-US&page=1&primary_release_year='+year)
  ...
  function LoadingFunction(){
    ...
    return(
      ...
      onPress={()=>navigation.navigate('ByYear2')}>
